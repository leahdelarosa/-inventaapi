...
import { KeyRound, Mail, AlertCircle, ArrowRight, Zap, Shield, BarChart3, Store, Building2, ShoppingCart, Utensils, Warehouse, Package } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <div className="flex items-center gap-4 mb-8">
                <div className="flex items-center gap-2 text-slate-300">
                  ...
                  <span className="text-sm">DPA 2012 Compliant</span>
                </div>
                <div className="flex items-center gap-2 text-slate-300">
              ...
              <div className="glass-card rounded-xl p-6 border border-indigo-500/20">
                <h3 className="text-lg font-semibold text-white mb-2">Why Choose InventaAPI?</h3>
                <ul className="space-y-2 text-slate-300 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-1">✓</span>
                    <span>Support for 8 different business types</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-1">✓</span>
            ...
            <div className="lg:sticky lg:top-8">
              <div className="glass-card rounded-2xl p-8 border border-indigo-500/30 shadow-2xl">
                <div className="text-center mb-6">
                  ...
                  <p className="text-slate-400 text-sm mt-2">Access your Data-as-a-Service platform</p>
                </div>
